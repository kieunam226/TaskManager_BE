...
const exportTasksReport = async (req, res) => {
  try {
    ...
    // FIX 5: Di chuyển setHeader và write ra ngoài forEach
    res.setHeader(
      "Content-Type",
  ...
  try {
    ...
    users.forEach((user) => {
      userTaskMap[user._id] = {
        ...
        taskCount: 0,
        pendingTasks: 0,
        inProgressTasks: 0, // FIX 7: inProgressTasks (đã sửa typo inProgessTasks)
        completedTasks: 0,
      };
    });
